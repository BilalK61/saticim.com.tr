...
const Hizmetler = () => {
    ...
    const fetchListings = async () => {
        ...
        try {
            let query = supabase.from('listings').select('*').eq('status', 'approved').eq('category', 'hizmetler').order('created_at', { ascending: false });
    ...
    const services = ['Ev Tadilat & Dekorasyon', 'Nakliye', 'Temizlik', 'Özel Ders', 'Tamirat & Teknik Servis', 'Düğün & Organizasyon', 'Web Tasarım & Yazılım', 'Diğer'];
            ...
            <div className="container mx-auto px-4 py-6 flex flex-col lg:flex-row gap-6">
                ...
                <aside className="w-full lg:w-72 flex-shrink-0">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className={`p-4 ${showMobileFilters ? 'block' : 'hidden lg:block'}`}>
                            ...
                            {/* Service Category */}
                            <FilterSection title="Hizmet Kategorisi">
                            ...
                            {/* Price (Usually minimal for services but good to have) */}
                            <FilterSection title="Bütçe Aralığı (TL)">
                ...
                <main className="flex-1">
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <div>
                            <h1 className="text-xl font-bold text-gray-900">Hizmet İlanları</h1>
